    ...
    <section className="mx-auto w-full max-w-6xl px-4 py-16 sm:px-6 sm:py-24">
      ...
      >
        <h1 className="font-serif text-4xl font-bold tracking-tight text-[#fff6e8] sm:text-5xl">
          About BestLife Matrimony
        </h1>
        <p className="mt-6 text-lg text-[#f3e6d8]/90">
          BestLife Matrimony is a modern matrimony platform that combines
          timeless family values with modern technology. We help individuals
          and families connect with compatible life partners in a safe,
          respectful and private environment.
        </p>
        <p className="mt-4 text-lg text-[#f3e6d8]/80">
          Built with React, TypeScript, Tailwind CSS and shadcn/ui, this
          starter template is production-ready for shared hosting deployments.
        </p>
