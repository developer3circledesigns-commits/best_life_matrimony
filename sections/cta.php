  ...
  <div class="max-w-7xl mx-auto">
    <div class="reveal-scale relative overflow-hidden rounded-3xl border border-[#f6e6b4]/40 bg-gradient-to-b from-black/85 via-black/70 to-black/90 p-8 sm:p-16 text-center backdrop-blur-2xl">
      ...
      <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
        <a href="./register.php" class="inline-flex h-13 w-full sm:w-auto items-center justify-center gap-2 rounded-full border border-[#f6e6b4]/60 bg-gradient-to-r from-[#dcb04a] via-[#e3c877] to-[#dcb04a] px-10 text-base font-bold text-[#3a0c15] shadow-[0_16px_36px_-12px_rgba(220,176,74,0.85)] hover:scale-105 transition-all">
          Register Now <svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
        </a>
