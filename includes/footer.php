...
<footer class="site-footer relative border-t border-[#3a0c15]/10 bg-[#fdf9f1] pt-16 pb-12 text-[#3a0c15] text-center md:text-left">
  <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <!-- Contact + Follow -->
      <div class="space-y-5 lg:col-span-2 text-center md:text-left">
        <div class="space-y-3">
          <h4 class="font-serif text-sm font-bold uppercase tracking-wider text-[#8a4a2f]">Contact</h4>
          <ul class="space-y-2.5 text-xs sm:text-sm text-[#3a0c15]/70 flex flex-col items-center md:items-start">
            <li class="flex items-center gap-2"><svg class="h-4 w-4 text-[#8a4a2f] shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.8 19.8 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6A19.8 19.8 0 0 1 2.1 4.18 2 2 0 0 1 4.08 2h3a2 2 0 0 1 2 1.72c.12 1.33.4 2.63.84 3.89a2 2 0 0 1-.58 2.11l-1.34 1.34a16 16 0 0 0 6 6l1.34-1.34a2 2 0 0 1 2.11-.58c1.26.44 2.56.72 3.89.84A2 2 0 0 1 22 16.92Z"/></svg><span>Phone: <a href="tel:+917338877275" class="whitespace-nowrap hover:text-[#8a4a2f] hover:underline">+91 7338877275</a> / <a href="tel:+917200005622" class="whitespace-nowrap hover:text-[#8a4a2f] hover:underline">+91 7200005622</a></span></li>
